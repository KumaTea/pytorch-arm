...
template_files = ['DF_Template', 'DF_FULL_Template']
...
def generate_dockerfile(tag, sha256, template, project='python', full=False):
    ...
    if full:
        with open(f'{dockerfile_path}/full.Dockerfile', 'w') as f:
